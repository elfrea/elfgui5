...
void eButton::on_mouse_drag_in(DragPacket* dragpacket,int mx,int my){}
...
//***** SET CUSTOM
void eButton::set_custom(Texture* lay,Texture* lay_pushed,Texture* lay_hover,Texture* dlay,bool autosize,bool sh_text,bool sh_tex)
{
	custom_layout=lay;
...
//***** SET CUSTOM
void eButton::set_custom(const Str& lay,const Str& lay_pushed,const Str& lay_hover,const Str& dlay,bool autosize,bool sh_text,bool sh_tex)
{

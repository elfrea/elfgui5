...
class eModal:public Element
{
public:

	//own config vars
	bool close_with_mouse;
	...
	//constructor
	eModal(const Str& ename,int ex,int ey,int ew,int eh,bool eclose_with_mouse,bool tint,class Element* elink);
	//destructor
	~eModal();
